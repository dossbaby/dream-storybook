...
**현재**: "내 맘을 모를 때" 또는 "맘을 모를 때"

**분석**:

| 옵션 | 장점 | 단점 |
|------|------|------|
| "내 맘을 모를 때" | 자기 자신에 집중, 자기성찰 느낌 | 타인의 마음 궁금할 때는 안 맞음 |
| "맘을 모를 때" | 포괄적 (내 맘/네 맘/그 사람 맘), 간결함 | "누구의 맘"인지 모호할 수 있음 |

**앱의 본질 고려**:
- 타로/꿈/사주 = 대부분 **관계** 질문 (연애, 상대방 마음, 미래)
- "그 사람이 날 좋아할까?" = 가장 흔한 질문
- 자기 자신의 마음도 모를 때 쓰긴 함
